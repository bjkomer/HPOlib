...
def restore(config, optimizer_dir, **kwargs):
    ...
    tree_trials = state['trials']._trials
...
def main(config, options, experiment_dir, **kwargs):
    ...
    if options.restore:
        ...
        optimizer_dir = os.path.join(experiment_dir, "tree_" +
                                     str(options.seed) + "_" +
                                     time_string)
